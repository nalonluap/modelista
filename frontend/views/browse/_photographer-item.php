...
<div class="model-item">
  <div class="model-item__content">
    ...
    <header class="model-item__header">
      <a href="/photographer/<?= $model->id ?>" title="<?= $modelName ?>" class="avatar">
      ...
      <div class="main-details">
        <div class="main-details__top">
          <a href="/photographer/<?= $model->id ?>" title="<?= $modelName ?>" class="name"><?= $modelName ?></a>
          <a href="#" class="favorite js-favorite-btn" data-id="<?= $model->id ?>" data-type="<?= User::TYPE_PHOTOGRAPHER ?>">
    ...
    <div class="model-item__actions">
      <a href="/photographer/<?= $model->id ?>" title="<?= $modelName ?>" class="btn border-btn">Портфолио</a>
