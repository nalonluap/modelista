...
<div class="filter-row">
  ...
  <form class="filter-search-form" action="/browse/photographers" method="get">
    <div class="ico">
    ...
    <input type="text" class="js-search-input" name="search" value="<?= isset($_GET['search']) ? $_GET['search'] : '' ?>" placeholder="Поиск по имени фотографа">
  </form>
</div>
...
<div class="filter js-filter">
  ...
  <form class="filter__form" action="/browse/photographers" method="get">
      ...
      <div class="column">
        ...
        <div class="column__item">
          ...
          <div class="control">
            <div class="range-row">
              <div class="range-col">
                <input type="number" name="" value="" placeholder="От">
              </div>
              <div class="range-col">
                <input type="number" name="" value="" placeholder="До">
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="form__actions">
      <div class="container">
        <a href="/browse/photographers" class="btn clear-btn">Очистить</a>
